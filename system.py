...
class BARTSeq2seq(pl.LightningModule):
    ...
    def __init__(self, hparams, is_inference=False):
        ...
        self.dataset_cls = GeneratorDataset
    ...
    def _step(self, batch):
        #print('batch',batch)
        model_outputs = self(**batch['net_input'])
    ...
    def validation_epoch_end(self, outputs):
        ...
        result.log("val_acc", val_acc_mean, prog_bar=True)
        result.log("val_ppl", val_ppl_mean, prog_bar=True)
        return result