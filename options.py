...
def _add_generation_args(parser):
    ...
    parser.add_argument('--generation-test', action='store_true')
    parser.add_argument('--use-pplm', action='store_true')
    parser.add_argument('--no-template', action='store_true')
    
def _add_pplm_args(parser):
    parser.add_argument('--decay', action='store_true')
    parser.add_argument('--gm_scale', default=0.95, type=float)
    ...
    parser.add_argument('--verbosity_level', default=1, type=int)
